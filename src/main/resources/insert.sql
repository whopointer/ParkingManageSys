...
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A11111","红色","张三","123","13011111111","permanent","A0001");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A22222","白色","李四","123","13011112222","permanent","A0002");

INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A33333","蓝色","王五","123","13011113333","permanent","A0003");

INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A44444","绿色","赵六","123","13011114444","permanent","A0004");

INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A55555","彩色","钱老三","123","13011115555","permanent","A0005");

INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A66666","砖红色","高老四","123","13011116666","permanent","A0006");

INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A77777","五颜六色","王老五","123","13011117777","permanent","A0007");

INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A88888","好看的颜色","白举人","123","13011118888","permanent","A0008");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A99999","白色","阿Q","123","13011119999","permanent","A0009");

INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone,Card_Type,Card_Num)
                       VALUES
                       ("苏A12345","蓝色","假洋鬼子","123","13011110000","permanent","A0010");
# 插入10条临时卡用户
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A21111","白色","老张","123","15011110000");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A31111","蓝色","老李","123","15011111111");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A41111","红色","王自在","123","15011112222");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A51111","蓝色","李自成","123","15011113333");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A61111","绿色","朱元璋","123","15011114444");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A71111","黄色","康熙","123","15011115555");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A81111","金黄色","武则天","123","15011116666");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A91111","浅蓝色","秦始皇","123","15011117777");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A10111","蓝色","苏轼","123","15011118888");
INSERT INTO Users (Car_Id,Color,User_Name,User_PassWord,User_Phone)
                       VALUES
                       ("苏A43210","黑色","苏洵","123","15011119999");
######################################################################################
# 插入车位表
#插入10条专有车位
...
INSERT INTO Booking_information(Space_Id,Car_Id,Booking_Time,Arrival_Time, Booking_Fee)
                       VALUES
                       (11,"苏A21111","2023-06-05 22:33:36","2023-06-05 23:33:36",12.3);
INSERT INTO Booking_information(Space_Id,Car_Id,Booking_Time,Arrival_Time, Booking_Fee)
                       VALUES
                       (12,"苏A31111","2023-06-06 22:33:36","2023-06-06 23:33:36",22);
INSERT INTO Booking_information(Space_Id,Car_Id,Booking_Time,Arrival_Time, Booking_Fee)
                       VALUES
                       (13,"苏A41111","2023-06-07 22:33:36","2023-06-07 23:33:36",15.3);
INSERT INTO Booking_information(Space_Id,Car_Id,Booking_Time,Arrival_Time, Booking_Fee)
                       VALUES
                       (14,"苏A51111","2023-06-08 22:33:36","2023-06-08 23:33:36",6.3);
...
INSERT INTO Parking(Car_Id,Space_Id,Arrival_Time)
                       VALUES
                       ("苏A11111",1,"2023-06-08 22:33:36");
INSERT INTO Parking(Car_Id,Space_Id,Arrival_Time)
                       VALUES
                       ("苏A22222",2,"2023-06-08 22:33:36");

INSERT INTO Parking(Car_Id,Space_Id,Arrival_Time)
                       VALUES
                       ("苏A33333",3,"2023-06-08 22:33:36");

INSERT INTO Parking(Car_Id,Space_Id,Arrival_Time)
                       VALUES
                       ("苏A44444",4,"2023-06-08 22:33:36");
INSERT INTO Parking(Car_Id,Space_Id,Arrival_Time)
                       VALUES
                       ("苏A55555",5,"2023-06-08 22:33:36");
